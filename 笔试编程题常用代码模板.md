...
(1) 实现对存放有pair的数组按first元素排序，即实现类似map的功能
...
通过单调递减栈，实现寻找数组中下一个比当前元素大的元素。[动画](https://leetcode-cn.com/problems/next-greater-element-ii/solution/xia-yi-ge-geng-da-yuan-su-ii-by-leetcode/)
